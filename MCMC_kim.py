# Summary: MCMC_kim.py
# This is a 3 parameter MCMC fit for the Kim et al. data so is not really used
# It is only slightly different from MCMC_3var.py
# More notes about MCMC in MCMC_2var3.py
...
def run_MCMC3(DeltaM, df_kim, D_errors, minimum=True):
